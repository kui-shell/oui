...
interface ResourceWithNonOptionalMetadata extends ResourceWithMetadata {
  metadata: Metadata
}
...
export function hasAnnotation(resource: WithAnnotations, key: string): boolean {
  return !!resource.annotations.find(_ => _.key === key)
}
